...
struct BBDebugScope_31 _m_stringbuffer_core_TStringBuffer_scope ={
...
static int _bb_bmk_stringbuffer_core_inited = 0;
int _bb_bmk_stringbuffer_core(){
	if (!_bb_bmk_stringbuffer_core_inited) {
		_bb_bmk_stringbuffer_core_inited = 1;
